...
from cinema_service1.cinema.models import Movie, MovieSession, CinemaHall, Genre, Actor
from cinema_service1.cinema.serializers import MovieListSerializer, MovieDetailSerializer
